...
const Routes = () => {
  ...
  const router = createBrowserRouter([
    ...
    // Proje rotaları
    {
      ...
      element: <WithLayout><ProjectDetail /></WithLayout>,
      errorElement: <WithError error={{ status: 500 }} />
    },
    {
      path: "/projects/:projectId/settings",
      element: <WithLayout><ProjectSettings /></WithLayout>,
      errorElement: <WithError error={{ status: 500 }} />
    },
    // Görev rotaları
    {
      path: "/projects/:projectId/tasks/:taskId/edit",
      element: <WithLayout><TaskEdit /></WithLayout>,
      errorElement: <WithError error={{ status: 500 }} />
    },
    {
